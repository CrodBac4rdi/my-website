...
export default function Hero({ highlights = [] }: { highlights?: any[] }) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 lg:grid-rows-2 gap-6 h-auto lg:h-[600px]">
      ...
      <div className="lg:col-span-3 lg:row-span-2 relative rounded-[2.5rem] overflow-hidden border border-line shadow-2xl group min-h-[400px] lg:min-h-full">
          ...
          >
            ...
            <div className="relative z-20 space-y-6">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 text-primary-400 px-4 py-2 rounded-2xl font-bold uppercase text-xs tracking-widest backdrop-blur-md"
              >
                <Sparkles size={16} />
              ...
              <motion.h1 
                ...
                className="font-display text-4xl md:text-7xl font-bold tracking-tight text-white leading-none max-w-2xl drop-shadow-2xl"
              >
              ...
              <motion.p 
                ...
                className="text-muted font-medium max-w-xl text-sm md:text-lg italic line-clamp-2 leading-relaxed"
              >
              ...
              >
                <button 
                  ...
                  className="bg-primary-600 hover:bg-primary-500 text-white flex items-center gap-3 px-8 py-4 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-primary-500/20"
                >
      ...
      <motion.div 
        ...
        className="relative overflow-hidden bg-elev border border-white/10 p-8 flex flex-col justify-between cursor-pointer group rounded-[2rem] hover:border-white/20 transition-all min-h-[200px] lg:min-h-full"
      >
        ...
        {highlights[1]?.backdrop_path && (
          <>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-bg via-elev/80 to-transparent"></div>
          </>
        )}

        <div className="relative z-10 p-4 bg-primary-600/20 border border-primary-500/30 text-primary-400 rounded-2xl w-fit group-hover:scale-110 transition-transform shadow-lg shadow-primary-500/10">
          <Calendar size={32} />
        </div>
        <div className="relative z-10">
          <h3 className="text-2xl font-extrabold text-white tracking-tight leading-none">Release <br/> Planer</h3>
          <p className="text-primary-400 font-bold mt-2 uppercase text-[10px] tracking-widest drop-shadow-md">Wann kommen neue Folgen?</p>
        </div>
      </motion.div>
